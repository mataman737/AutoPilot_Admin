...
extension MyBrokersHeader {
    func setupViews() {
        ...
        whiteView.heightAnchor.constraint(equalToConstant: 79.5).isActive = true
        ...
        checkoutTitleLabel.topAnchor.constraint(equalTo: whiteView.topAnchor, constant: 15).isActive = true
        ...
        dismissArrowImageView.leadingAnchor.constraint(equalTo: whiteView.leadingAnchor, constant: 20).isActive = true
        dismissArrowImageView.topAnchor.constraint(equalTo: checkoutTitleLabel.centerYAnchor, constant: -10).isActive = true
        dismissArrowImageView.heightAnchor.constraint(equalToConstant: 24).isActive = true
        dismissArrowImageView.widthAnchor.constraint(equalToConstant: 24).isActive = true
        ...
        dismissButton.bottomAnchor.constraint(equalTo: dismissArrowImageView.bottomAnchor, constant: 10).isActive = true
        dismissButton.trailingAnchor.constraint(equalTo: dismissArrowImageView.trailingAnchor, constant: 10).isActive = true
        ...
        numberOfItemsLabel.topAnchor.constraint(equalTo: checkoutTitleLabel.bottomAnchor, constant: 4).isActive = true
