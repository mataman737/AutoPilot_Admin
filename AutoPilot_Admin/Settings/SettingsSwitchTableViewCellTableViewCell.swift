//
//  SettingsSwitchTableViewCellTableViewCell.swift
//  AutoPilot_Admin
//
...
class SettingsSwitchTableViewCellTableViewCell: UITableViewCell {
...
extension SettingsSwitchTableViewCellTableViewCell {
    ...
    func setupViews() {
        ...
        pwSwitchContainer.layer.cornerRadius = .createAspectRatio(value: 26)/2
        pwSwitchContainer.layer.masksToBounds = true
