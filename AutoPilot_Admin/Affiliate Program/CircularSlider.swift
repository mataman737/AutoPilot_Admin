...
open class CircularSlider: UIView {
    ...
    @IBInspectable
    open var maximumValue: Float = 200//500
    @IBInspectable
    ...
    @IBInspectable
    open var pgHighlightedColor: UIColor = UIColor.themeOrange {
        didSet {
            appearanceProgressLayer()
        }
    }
    ...
    */
    ...
    fileprivate func appearanceKnobLayer() {
        ...
        knobLayer.strokeColor = UIColor(red: 40/255, green: 40/255, blue: 40/255, alpha: 1.0).cgColor
    }
    ...
    fileprivate func setStrokeEnd(animated: Bool) {
        ...
        strokeAnimation.duration = animated ? 0.35 : 0
