...
extension LoginViewController {
    ...
    func setupViews() {
        ...
        progressZero.trailingAnchor.constraint(equalTo: navView.centerXAnchor, constant: -.createAspectRatio(value: 4)).isActive = true
        setupProgressView(progressView: progressOne)
        progressOne.leadingAnchor.constraint(equalTo: navView.centerXAnchor, constant: .createAspectRatio(value: 4)).isActive = true
...
//        userInfoContainer.widthAnchor.constraint(equalToConstant: view.frame.width).isActive = true
        ...
        phoneNumberContainer.leadingAnchor.constraint(equalTo: mainScrollView.leadingAnchor).isActive = true
