//
//  ModifyOpenOrderViewController.swift
//  AutoPilot_Admin
//
    ...
    override func viewDidLoad() {
        ...
        if let forexTPPrice2 = forexSignal?.instantTrade?.takeProfit2 {
            if forexTPPrice2 != "" {
                ...
                takeProfitSelected = forexTPPrice2
            }
        }
...
extension ModifyOpenOrderViewController {
    ...
    func getAccounts() {
        /*
        API.sharedInstance.getTradingAccounts { success, accounts, error in
...
extension ModifyOpenOrderViewController: PickOptionViewControllerDelegate {
...
extension ModifyOpenOrderViewController: SwipeConfirmViewDelegate {
