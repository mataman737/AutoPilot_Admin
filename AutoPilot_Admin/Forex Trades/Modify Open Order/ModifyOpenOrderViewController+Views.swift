//
//  ModifyOpenOrderViewController+Views.swift
//  AutoPilot_Admin
//
...
extension ModifyOpenOrderViewController {
    ...
    func setupViews() {
        ...
        entryPriceContainer.isHidden = true
        ...
        if let stopString = forexSignal.order?.stopLoss {
            ...
            if let stopStringTwo = forexSignal.instantTrade?.stopLoss {
                setupTextField(txtField: stopLossTextField, pinView: stopLossContainer, theText: stopStringTwo)
            } else {
        ...
        bulletZero.backgroundColor = .black.withAlphaComponent(0.75)
        ...
        bulletOne.backgroundColor = .black.withAlphaComponent(0.75)
        ...
        swipeView.swipeLabel.text = "Modify Order"
        //swipeView.alpha = 0
